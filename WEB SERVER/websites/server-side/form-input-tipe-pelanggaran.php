         ...
         <div class="container animated fadeIn">
            <div class="row">
               <div class="col xl12 l12 m12 s12">
                  <h5 class="breadcrumbs-title mt-0 mb-0"><span>Form Input Tipe Pelanggaran</span></h5>
                  <ol class="breadcrumbs mb-0">
                     <li class="breadcrumb-item"><a href="dashboard">Dashboard</a>
                     </li>
                     <li class="breadcrumb-item"><a href="form-input-tipe-pelanggaran">Input Tipe Pelanggaran</a>
                     </li>
                     <li class="breadcrumb-item active">Form Input Tipe Pelanggaran
                     </li>
                  </ol>
               </div>
            </div>
         ...
         <div class="container animated fadeIn">
            <div id="validation" class="card card card-default scrollspy">
               <div class="card-content">
                  <h4 class="card-title">Tambah Data Tipe Pelanggaran Siswa</h4>
                  <form method="POST" autocomplete="OFF">
                     <div class="row">
                        <input name="KodeTP" type="hidden" class="validate" value="<?php echo GenerateCodeTP() ?>" readonly>
                        <div class="input-field col xl6 l6 m12 s12 mt-3">
                           <i class="material-icons prefix">report</i>
                           <input type="text" class="validate" name="TipePelanggaran" placeholder="Example : Merusak Fasilitas Sekolah" maxlength="50" oninput="this.value = this.value.replace(/[^a-zA-Z, ]/, '')" style="text-transform: capitalize;">
                           ...
                           <select name="KodeLP">
                              ...
                              <?php
                                 ...
                                 while ($GetData = mysqli_fetch_array($GetTableTP)) {
                                    echo "
                                       <option value='$GetData[KodeLP]'>$GetData[LevelPelanggaran]</option>
                                    ";
                                 }
                              ?>
                           </select>
                        ...
                        <div class="input-field col s12 mb-2">
                           <button type="submit" class="btn gradient-45deg-red-pink waves-effect waves-light right" name="insert-into-TP">
