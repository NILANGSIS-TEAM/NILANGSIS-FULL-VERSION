         ...
         <div class="container animated fadeIn">
            <div class="row">
               <div class="col xl12 l12 m12 s12">
                  <h5 class="breadcrumbs-title mt-0 mb-0"><span>Form Edit Profile</span></h5>
                  <ol class="breadcrumbs mb-0">
                     <li class="breadcrumb-item"><a href="dashboard">Dashboard</a>
                     </li>
                     <li class="breadcrumb-item"><a href="user-profile">User Profile</a>
                     </li>
                     <li class="breadcrumb-item active">Form Edit Profile
                     </li>
                  </ol>
               </div>
            </div>
                  ...
                  <form method="POST" autocomplete="OFF">
                     <div class="row">
                        ...
                        <div class="input-field col xl6 l6 m12 s12 mt-4">
                           ...
                           <input type="text" class="validate" name="NamaGR" placeholder="Example : Juandi Kurniawan, S.Pd" oninput="this.value=this.value.replace(/[^a-zA-Z,. ]/, '')" maxlength="40" value="<?php echo $GetData['NamaGR']; ?>">
                        ...
                        <div class="input-field col xl6 l6 m12 s12 mt-4">
                           ...
                           <input type="text" class="validate" name="TempatLahir" placeholder="Masukan tempat lahir" oninput="this.value=this.value.replace(/[^a-zA-Z,. ]/, '')" maxlength="20" value="<?php echo $GetData['TempatLahir']; ?>">
                        ...
                        <div class="input-field col s12 mt-4">
                           ...
                           <textarea class="materialize-textarea" name="Alamat" placeholder="Example : Jl. Remartadinata, Gg. Remaja No.50, Kec.Bondowoso, Bondowoso Kota"><?php echo $GetData['Alamat'] ?></textarea>
                           <label>Alamat Tempat Tinggal</label>
                        </div>
                        <div class="input-field col s12 mb-2">
                           <button type="submit" class="btn gradient-45deg-red-pink waves-effect waves-light right" name="update-user-profile">
                              <i class="material-icons right">save</i>
                              Simpan
                           </button>
                           <a href="user-profile" class="btn grey darken-2 waves-effect waves-light right mr-2">
