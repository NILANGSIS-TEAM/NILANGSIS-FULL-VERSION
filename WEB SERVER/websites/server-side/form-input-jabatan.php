         ...
         <div class="container animated fadeIn">
            <div class="row">
               <div class="col xl12 l12 m12 s12">
                  <h5 class="breadcrumbs-title mt-0 mb-0"><span>Form Input Jabatan</span></h5>
                  <ol class="breadcrumbs mb-0">
                     <li class="breadcrumb-item"><a href="dashboard">Dashboard</a>
                     </li>
                     <li class="breadcrumb-item"><a href="form-input-jabatan">Input Jabatan</a>
                     </li>
                     <li class="breadcrumb-item active">Form Input Jabatan
                     </li>
                  </ol>
               </div>
            </div>
         ...
         <div class="container animated fadeIn">
            <div id="validation" class="card card card-default scrollspy">
               <div class="card-content">
                  <h4 class="card-title">Tambah Data Jabatan Pegawai</h4>
                  <form method="POST" autocomplete="OFF">
                     <div class="row">
                        <input name="KodeJBT" type="hidden" class="validate" value="<?php echo GenerateCodeJabatan() ?>" readonly>
                        <div class="input-field col xl9 l9 m12 s12 mt-3 mb-2">
                           <i class="material-icons prefix">verified_user</i>
                           <input type="text" class="validate" name="Jabatan" placeholder="Example : Guru Mata Pelajaran" maxlength="30" oninput="this.value=this.value.replace(/[^a-zA-Z, ]/, '')" style="text-transform: capitalize;">
                           <label>Jabatan Pegawai</label>
                        </div>
                        <div class="input-field col xl3 l3 m12 s12 mt-3 mb-2">
                           <button type="submit" class="btn gradient-45deg-red-pink waves-effect waves-light right" name="insert-into-jabatan">
