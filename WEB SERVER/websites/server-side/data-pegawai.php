...
<div id="main">
   <div class="row">
         ...
         <div class="container animated fadeIn">
            <div class="row">
               <div class="col xl12 l12 m12 s12">
                  <h5 class="breadcrumbs-title mt-0 mb-0"><span>Data Pegawai</span></h5>
                  <ol class="breadcrumbs mb-0">
                     <li class="breadcrumb-item"><a href="dashboard">Dashboard</a>
                     </li>
                     <li class="breadcrumb-item"><a href="data-pegawai">Master Data</a>
                     </li>
                           ...
                           <div class="row">
                              <div class="col s12">
                                 <table id="page-length-option" class="highlight">
                                    ...
                                    <tbody>
                                       <?php require 'process/select-data.php'; SelectDataPegawai(); ?>
                                    </tbody>
                                    <tfoot>
                                       <tr>
                                          <th>#No</th>
      ...
      <div style="bottom: 50px; right: 19px;" class="fixed-action-btn direction-bottom animated tada">
         <a class="btn-floating btn-large gradient-45deg-red-pink gradient-shadowtooltipped tooltipped" data-position="left" data-tooltip="Tambah data pegawai" href="form-input-pegawai">
