         ...
         <div class="container animated fadeIn">
            <div class="row">
               <div class="col xl12 l12 m12 s12">
                  <h5 class="breadcrumbs-title mt-0 mb-0"><span>Detail Pegawai</span></h5>
                              ...
                              <div class="col s12 m12 mt-1">
                                 <div class="card-panel border-radius-6 mt-3">
                                    <div class="row">
                                       ...
                                       <div class="col m2">
                                          <a href="form-edit-pegawai?NIP=<?php echo $NIP ?>" class="btn blue waves-effect waves-light right mt-10">Edit Data</a>
                                       </div>
                                       <div class="col m12 mt-2">
                                          <div class="row">
                                             ...
                                             <div class="col m12 mt-3 mb-1">
                                                <a href="data-pegawai" class="btn waves-effect wafes-light grey darken-2">
                                                   Kembali
                                                </a>
                                             </div>
                                          </div>
